...
var InformationComponent = /** @class */ (function (_super) {
    ...
    InformationComponent.prototype.render = function () {
        ...
        return ((0, preact_1.h)(Template_1["default"], { template: containerTemplate, data: formattedTemplateData, className: "as-information " + containerClassName, dictionary: this.props.dictionary }));
    };
