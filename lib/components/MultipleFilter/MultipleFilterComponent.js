...
var MultipleFilterComponent = /** @class */ (function (_super) {
    ...
    MultipleFilterComponent.prototype.componentWillMount = function () {
         ...
         * Dispatch action
         */
        (0, MultipleFilterActions_1.aggregationSetup)(props.environmentId, props.store.getCurrentQuery(), props.filterName, props.filterField, aggregationField, applicationType, props.sortBy, fetchLimit, props.ranges);
    };
    /**
    ...
    MultipleFilterComponent.prototype.render = function () {
        ...
        return ((0, preact_1.h)("div", { className: "as-multipleFilter " + containerClassName },
            (0, preact_1.h)(Template_1["default"], { template: topTemplate, className: "as-multipleFilter__top " + topClassName, dictionary: this.props.dictionary }),
            (0, preact_1.h)("div", { className: "as-multipleFilter__itemsList " + itemsListClassName },
