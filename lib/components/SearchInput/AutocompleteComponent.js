...
var AutocompleteComponent = /** @class */ (function (_super) {
    ...
    AutocompleteComponent.prototype.render = function () {
        ...
        return ((0, preact_1.h)("input", { type: "text", className: "as-searchInput__input as-searchInput__autocomplete " + inputClassName, placeholder: formattedAutocompleteText, style: "position: absolute; top: 0px; left: 0px; background-color: white;" }));
    };
