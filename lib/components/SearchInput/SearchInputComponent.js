...
var SearchInputComponent = /** @class */ (function (_super) {
    ...
    SearchInputComponent.prototype.componentWillMount = function () {
         ...
         * Dispatch action
         */
        (0, SearchInputActions_1.initialSearchSetup)(props.environmentId, props.store.getCurrentQuery(), props.initialSearch, props.autocomplete, props.searchableFields, props.queryOperator);
    };
    /**
    ...
    SearchInputComponent.prototype.render = function () {
        ...
        if (this.speechRecognition) {
            searchInput = ((0, preact_1.h)("div", { style: "position: relative" },
                searchInput,
                (0, preact_1.h)("div", { "class": "as-searchInput-speechRecognition", onClick: function (e) { return _this.onSpeechStart(e, _this.speechRecognition); } },
                    (0, preact_1.h)(Template_1["default"], { template: props.template.speechRecognition, dictionary: props.dictionary }))));
        }
        if (withContainer) {
            searchInput = ((0, preact_1.h)("div", { className: "as-searchInput " + containerClassName },
                searchInput,
                (clearSearch && currentQueryText && currentQueryText.length !== 0)
                    ? ((0, preact_1.h)("div", { className: "as-searchInput__clearSearch " + clearSearchClassName, onClick: this.clearSearch },
