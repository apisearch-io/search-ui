...
var RangeFilterComponent = /** @class */ (function (_super) {
    ...
    RangeFilterComponent.prototype.componentWillMount = function () {
         ...
         * Dispatch action
         */
        (0, RangeFilterActions_1.aggregationSetup)(environmentId, currentQuery, filterName, filterField);
    };
    ...
    RangeFilterComponent.prototype.render = function (props, state) {
        ...
        return ((0, preact_1.h)("div", { id: this.rangeUid, className: "as-rangeFilter " + containerClassName, style: visibleStyle },
            (0, preact_1.h)(Template_1["default"], { template: topTemplate, className: "as-rangeFilter__top " + topClassName, dictionary: this.props.dictionary }),
            (0, preact_1.h)("div", { className: "as-rangeFilter__wrapper " + wrapperClassName },
                (0, preact_1.h)("input", __assign({ type: type, "class": "as-rangeFilter__from " + props.classNames.input + " as-rangeFilter__" + this.uid + " as-rangeFilter__from__" + this.uid }, props.attributes.from, { value: from, min: min, max: max, step: props.step, onClick: function (e) {
                        if (isNotNative)
                            return false;
                ...
                (0, preact_1.h)("input", __assign({ type: type, "class": "as-rangeFilter__to " + props.classNames.input + " as-rangeFilter__" + this.uid + " as-rangeFilter__to__" + this.uid }, props.attributes.to, { value: to, min: min, max: max, step: props.step, onClick: function (e) {
                        if (isNotNative)
                            return false;
