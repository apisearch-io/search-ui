...
var ResultComponent = /** @class */ (function (_super) {
        ...
        _this.endResultsBoxRef = (0, compat_1.useCallback)(function (node) {
            ...
            _this.observer.current = new IntersectionObserver(function (entries) {
                if (entries[0].isIntersecting) {
                    ...
                    (0, ResultActions_1.infiniteScrollNextPageAction)(environmentId, store.getCurrentQuery(), repository, _this.state.page + 1);
                }
            });
    ...
    ResultComponent.prototype.render = function () {
        ...
        if (!currentVisibleResults || !this.state.focus) {
            return ((0, preact_1.h)("div", { className: "as-result " + containerClassName }));
        }
        /**
        ...
        if (props.template.itemsList !== defaultTemplates_1.defaultItemsListTemplate) {
            return ((0, preact_1.h)("div", { className: "as-result " + containerClassName, ref: wrapperRef, style: "position: relative" },
                (dirty)
                    ? (0, preact_1.h)(Template_1["default"], { template: placeholderTemplate, className: "as-result__placeholder " + placeholderClassName, dictionary: this.props.dictionary })
                ...
                hasInfiniteScrollNextPage
                    ? (0, preact_1.h)("div", { ref: this.endResultsBoxRef, style: "bottom: " + infiniteScrollMargin + "px; position: relative;" })
                    : ""));
        }
        /**
         * New version
         */
        return ((0, preact_1.h)("div", { className: "as-result " + containerClassName, ref: wrapperRef }, (dirty)
            ? (0, preact_1.h)(Template_1["default"], { template: placeholderTemplate, className: "as-result__placeholder " + placeholderClassName, dictionary: this.props.dictionary })
            : ((items.length > 0)
                ? ((0, preact_1.h)("div", { className: "as-result__itemsList " + props.classNames.itemsList },
                    items.map(function (item) {
                        return (0, preact_1.h)(Item_1["default"], { data: __assign(__assign({}, reducedTemplateData), _this.hydrateItem(item)), template: props.template.item, className: "as-result__item " + props.classNames.item, dictionary: _this.props.dictionary });
                    }),
                    hasInfiniteScrollNextPage
                        ? (0, preact_1.h)("div", { id: "as-result__infinite_scroll_inspector", ref: this.endResultsBoxRef, style: "bottom: " + infiniteScrollMargin + "px; position: relative; width: 100%;" })
                        : ""))
