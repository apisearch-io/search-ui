...
var SuggestionsFilterComponent = /** @class */ (function (_super) {
    ...
    function SuggestionsFilterComponent() {
        ...
        _this.handleClick = function (word) {
             ...
             * Dispatch action
             */
            (0, SuggestionsFilterActions_1.onWordClickAction)(props.environmentId, props.store.getCurrentQuery(), props.repository, word);
        };
        return _this;
    }
    /**
    ...
    SuggestionsFilterComponent.prototype.render = function (props, state) {
        ...
        var that = this;
        return ((0, preact_1.h)("div", { className: "as-suggestions " + containerClassName + " " + noSuggestionsClassName },
            (0, preact_1.h)(Template_1["default"], { template: topTemplate, className: "as-suggestions__top " + topClassName, dictionary: this.props.dictionary }),
            (0, preact_1.h)("div", { className: "as-suggestions__itemsList " + itemsListClassName }, state.words.map(function (word) {
                var templateData = {
                    word: word
                };
                return ((0, preact_1.h)("div", { className: "as-suggestions__item " + itemClassName, onClick: function (e) {
                        e.stopPropagation();
                        e.preventDefault();
