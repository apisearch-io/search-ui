...
var SortByComponent = /** @class */ (function (_super) {
    ...
    SortByComponent.prototype.render = function (props, state) {
        ...
        return ((0, preact_1.h)("div", { className: "as-sortBy " + containerClassName },
            (0, preact_1.h)("select", { className: "as-sortBy__selector " + selectClassName, onChange: this.handleChange, value: state.value }, options.map(function (option) { return ((0, preact_1.h)("option", { value: option.value }, option.name)); }))));
    };
